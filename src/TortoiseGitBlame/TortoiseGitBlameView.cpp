...
void CTortoiseGitBlameView::InitialiseEditor()
{
	...
	{
		SendEditor(SCI_SETTECHNOLOGY, CRegStdDWORD(L"Software\\TortoiseGit\\ScintillaDirect2DRetain", TRUE) ? SC_TECHNOLOGY_DIRECTWRITERETAIN : SC_TECHNOLOGY_DIRECTWRITE);
