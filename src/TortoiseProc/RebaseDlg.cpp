...
BOOL CRebaseDlg::OnInitDialog()
{
	...
	((CButton *)GetDlgItem(IDC_BUTTON_UP2))->SetIcon((HICON)::LoadImage(AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_JUMPUP), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR));
	((CButton *)GetDlgItem(IDC_BUTTON_DOWN2))->SetIcon((HICON)::LoadImage(AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_JUMPDOWN), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR));
